...
@protocol YYTestProtocol <NSObject>
...
@property (nonatomic, assign) NSInteger user_rank;
@property (nonatomic, weak) id <YYTestProtocol> testDelegate;
@property (nonatomic, copy) NSString *testStr;
//自定义setter和getter
@property (nonatomic, assign, getter=isTesting) BOOL testing;
@property (nonatomic, assign, setter=setHaahhhh:) BOOL haha;
...
@property (nonatomic, strong) YYWeiboUser *user2;
@property (nonatomic, strong) YYWeiboUser *user3;
@property (nonatomic, assign) int32_t userType;
@property (nonatomic, strong) NSString *text;
@property (nonatomic, strong) NSArray *picIds;        /// Array<NSString>
@property (nonatomic, strong) NSArray *testyeye_ids;  /// Array<NSNumber>  ///自己写的测试用的
